...
class StockSpider(Spider):
    ...
    def start_requests(self):
        ...
        url = "https://shop.11st.co.kr/stores/724098/category?isCategory=true&dispCtgrNo=1059820&categoryType=DISPLAY&largeCtgrNo=1059820"
    ...
    def parse_start(self, response):
       ...
       #driver.get("https://shop.11st.co.kr/stores/641053/category")
        driver.get("https://shop.11st.co.kr/stores/724098/category?isCategory=true&dispCtgrNo=1001393&categoryType=DISPLAY&largeCtgrNo=1001393")
                ...
                if(fee == "무료배송"):
                    ...
                    try:
                        ...
                        try:
                            ...
                            temp["name"] = a['content_name']
                            temp["old_price"] = ""
                            new_price = driver.find_element(By.XPATH,f'/html/body/div[2]/div[2]/div/div/div[2]/div[3]/div/section/div[2]/ul/li[{index}]/a/div[2]/span[1]/span[1]/em')
                            temp["new_price"] = new_price.text
                else:
                    temp["fee"] = "X"
                    try:
        ...
        df.to_excel('캠핑.xlsx', index=False)
    #def parse_se"price"
